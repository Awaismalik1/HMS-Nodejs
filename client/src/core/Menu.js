...
const Menu = () => {
    ...
    return (
            ...
            <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                <a className="navbar-brand" href="index.html">Hareem Fatima Poly Clinic</a>
            <button className="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="https://hfpolyclinic.com">
                </button>
